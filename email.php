<?php
  ...
  <html lang="en">
    ...
    <body>
      ...
      <p>Klik <a href="http://mbomarina.nl/activate?content=' . $activationpage . '&email=' . $email . '&pwh=' . $array["password_hash"] . '">hier</a> voor het activeren en wijzigen van het wachtwoord van uw account</p>
